...
public class Doctor {
	...
	/*
	 * //read json and store in arraylist public void readJsonAndStore() throws
	 * FileNotFoundException, IOException, ParseException { JSONParser parser = new
	 * JSONParser(); Object ob = parser.parse(new FileReader(filepath));
	 * 
	 * JSONArray arr=(JSONArray) ob; System.out.println(arr);
	 * ArrayList<JSONObject>arraylist=new ArrayList<JSONObject>(); for(int
	 * i=0;i<arr.size();i++) { JSONObject jobj=(JSONObject) arr.get(i);
	 * arraylist.add(jobj); }
	 * 
	 * }
	 */
