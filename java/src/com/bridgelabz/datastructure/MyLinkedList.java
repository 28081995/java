...
public class MyLinkedList<T> {
	...
	/**
	 * @param data
	 *            - data to be removed removes given element from the list
	 */
	...
	/**
	 * @param data
	 *            - elements to be searched in the list
	...
	/**
	 * @param data
	 *            - data to be added adds data to the end of the list
	 */
	...
	/**
	 * @param data
	 *            - element whose position is to be found out
